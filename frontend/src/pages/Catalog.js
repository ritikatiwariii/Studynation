...
const Catalog = () => {
    ...
    console.log("loading:", loading, "catalogPageData:", catalogPageData);

    if (loading || !catalogPageData) {
        console.log("In loading state or no data");
        return (
    ...
    console.log("selectedCategory:", catalogPageData?.data?.selectCategory);
    console.log("selectedCategory.name:", catalogPageData?.data?.selectCategory?.name);
    return (
        <>
            {/* Hero Section */}
