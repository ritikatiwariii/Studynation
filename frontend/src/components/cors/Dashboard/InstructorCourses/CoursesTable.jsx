...
import { formatDate } from "../../../../service/operations/formatDate"
import {
    deleteCourse,
                        ...
                        courses?.map((course) => (
                            ...
                            >
                                <Td className="flex flex-1 gap-x-4">
                                    <img
                                        src={imageErrors[course._id] ? "https://via.placeholder.com/220x148/1e293b/ffffff?text=Course+Image" : course?.thumbnail}
                                    ...
                                    <div className="flex flex-col justify-between">
                                        ...
                                        <p className="text-[12px] text-white">
                                            Created: {course.createdAt ? formatDate(course.createdAt) : course.createdOn ? formatDate(course.createdOn) : 'Date not available'}
                                        </p>
